...
def test_manifest_creation(tmp_path: Path) -> None:
    ...
    _ = ManifestManager(str(tmp_path))
...
def test_manifest_entry_management(tmp_path: Path) -> None:
...
def test_manifest_backup_creation(tmp_path: Path) -> None:
...
def test_manifest_missing_torrents(tmp_path: Path) -> None:
...
def test_manifest_cleaning(tmp_path: Path) -> None:
